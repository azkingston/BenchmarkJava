...
public class BenchmarkTest00445 extends HttpServlet {
        ...
        public void doPost(HttpServletRequest request, HttpServletResponse response)
                ...
                String e98384 = new String(
                                org.apache.commons.codec.binary.Base64.decodeBase64(
                                                org.apache.commons.codec.binary.Base64.encodeBase64(
                                                                d98384.getBytes()))); // B64 encode and decode it
                String f98384 = e98384.split(" ")[0]; // split it on a space
                org.owasp.benchmark.helpers.ThingInterface thing = org.owasp.benchmark.helpers.ThingFactory
                                .createThing();
                ...
                try {
                        ...
                        java.io.File fileTarget = new java.io.File(
                                        ...
                                        "passwordFile.txt");
                        java.io.FileWriter fw = new java.io.FileWriter(fileTarget, true); // the true will append the
                                                                                          // new data
                        fw.write(
                                        "secret_value="
